...
from tools.mcp.file_manager_client_stdio import file_manager_tools
...
agents_manager.run("Write the text \"Hello, World!\" to \"C:/tmp/mcp-stdio-managed-hello.txt\" and show me its content.")